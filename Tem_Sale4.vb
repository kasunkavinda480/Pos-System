...
Public Class Tem_Sale4
    ...
    End Sub
    Private Sub Tem_Sale4_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub Button7_Click(sender As Object, e As EventArgs) Handles Button7.Click
        ...
        Else
            ...
            Try
                Dim Query As String
                MySqlConn.Open()
                Query = "delete from dbsdatabase.tem_sale2"
    ...
    Private Sub AllitemsDataGridView_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles AllitemsDataGridView.CellContentClick
