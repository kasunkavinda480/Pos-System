...
Public Class Tem_Sale5
    Private Sub Tem_sale3BindingNavigatorSaveItem_Click(sender As Object, e As EventArgs)
        Me.Validate()
        Me.Tem_sale3BindingSource.EndEdit()
        Me.TableAdapterManager.UpdateAll(Me.DbsdatabaseDataSet)

    End Sub

    Private Sub Tem_Sale5_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim fresh As Integer = Tem_sale3DataGridView.Rows.Count - 1
        If fresh <= 0 Then
        Else
            TextBox1.Text = Tem_sale3DataGridView.Item(7, fresh).Value.ToString
            TextBox2.Text = Tem_sale3DataGridView.Item(8, fresh).Value.ToString
            TextBox3.Text = Tem_sale3DataGridView.Item(9, fresh).Value.ToString
            TextBox5.Text = Tem_sale3DataGridView.Item(10, fresh).Value.ToString
            TextBox4.Text = Tem_sale3DataGridView.Item(11, fresh).Value.ToString

            Dim mgsum As Double = 0
            For j As Integer = 0 To Tem_sale3DataGridView.Rows.Count() - 1 Step +1
                mgsum = mgsum + Tem_sale3DataGridView.Rows(j).Cells(5).Value
            Next
    ...
    Private Sub Button7_Click(sender As Object, e As EventArgs)
        ...
        Else
            For size As Integer = 0 To Tem_sale3DataGridView.Rows.Count - 1
                ...
                SellingDataGridView.Rows.Item(Ssize).Cells(4).Value = Tem_sale3DataGridView.Rows.Item(size).Cells(0).Value
                SellingDataGridView.Rows.Item(Ssize).Cells(5).Value = Tem_sale3DataGridView.Rows.Item(size).Cells(1).Value
                SellingDataGridView.Rows.Item(Ssize).Cells(6).Value = Tem_sale3DataGridView.Rows.Item(size).Cells(2).Value
                SellingDataGridView.Rows.Item(Ssize).Cells(7).Value = Tem_sale3DataGridView.Rows.Item(size).Cells(3).Value
                SellingDataGridView.Rows.Item(Ssize).Cells(8).Value = Tem_sale3DataGridView.Rows.Item(size).Cells(4).Value
                SellingDataGridView.Rows.Item(Ssize).Cells(9).Value = Tem_sale3DataGridView.Rows.Item(size).Cells(5).Value
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Dim m As Integer = Tem_sale3DataGridView.Rows.Count() - 1
        Tem_sale3DataGridView.Rows(m).Cells(7).Value = TextBox1.Text
        Tem_sale3DataGridView.Rows(m).Cells(8).Value = TextBox2.Text
        Tem_sale3DataGridView.Rows(m).Cells(9).Value = TextBox3.Text
        Tem_sale3DataGridView.Rows(m).Cells(10).Value = TextBox5.Text
        Tem_sale3DataGridView.Rows(m).Cells(11).Value = TextBox4.Text

        Dim ss As Integer = Tem_sale3DataGridView.Rows.Count() - 1
        Tem_sale3DataGridView.Rows(ss).Cells(6).Value = ss
