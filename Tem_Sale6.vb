...
Public Class Tem_Sale6
    Private Sub Tem_Sale6_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        'TODO: This line of code loads data into the 'DbsdatabaseDataSet.customer_payments' table. You can move, or remove it, as needed.
        ...
        Try
            ...
            Me.Tem_sale4TableAdapter.Fill(Me.DbsdatabaseDataSet.tem_sale4)
    ...
    Private Sub Button7_Click(sender As Object, e As EventArgs) Handles Button7.Click
        ...
        Else
            ...
            Try
                Dim Query As String
                MySqlConn.Open()
                Query = "delete from dbsdatabase.tem_sale4"
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Tem_sale4BindingSource.EndEdit()
        Tem_sale4TableAdapter.Update(DbsdatabaseDataSet.tem_sale4)
