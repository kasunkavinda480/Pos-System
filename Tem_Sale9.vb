...
Public Class Tem_Sale9
    Private Sub Tem_Sale9_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'DbsdatabaseDataSet1.tem_sale5' table. You can move, or remove it, as needed.
        Me.Tem_sale5TableAdapter.Fill(Me.DbsdatabaseDataSet1.tem_sale5)
        Try
    ...
    Private Sub Button7_Click(sender As Object, e As EventArgs) Handles Button7.Click
        ...
        Else
            ...
            Try
                Dim Query As String
                MySqlConn.Open()
                Query = "delete from dbsdatabase.tem_sale5"
    ...
    Private Sub IT_CodeTextBox_KeyDown_1(sender As Object, e As KeyEventArgs)

    End Sub

    Private Sub DescriptionTextBox_TextChanged_1(sender As Object, e As EventArgs)
    ...
    Private Sub QutTextBox_TextChanged_1(sender As Object, e As EventArgs)
    ...
    Private Sub Unit_PriceTextBox_TextChanged_1(sender As Object, e As EventArgs)

    End Sub

    Private Sub Unit_PriceTextBox_KeyDown_1(sender As Object, e As KeyEventArgs)
        If e.KeyCode = Keys.Enter Then
            DiscountTextBox.Select()
        End If
    End Sub

    Private Sub DiscountTextBox_TextChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub DiscountTextBox_KeyDown_1(sender As Object, e As KeyEventArgs)
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Tem_sale5BindingSource.EndEdit()
        Tem_sale5TableAdapter.Update(DbsdatabaseDataSet1.tem_sale5)
    ...
    Private Sub DiscountTextBox_TextChanged_1(sender As Object, e As EventArgs) Handles DiscountTextBox.TextChanged
